...
import org.khomenko.crypto.labs.core.bitutils.extractBetweenFirstLastBits
...
fun main() {
    ...
    val betweenBits = extractBetweenFirstLastBits(a, i)
    println("Bits between first/last i bist: ${betweenBits.toBinString()}")
}